...
// CREATE ENROLLMENT BY STUDENT ONLY
...
// GET ALL ENROLLMENTS BY EDUCATOR
...
// GET ENROLLMENT BYEDUCATOR
export const getEnrollmentById = async (req: Request, res: Response) => {
    try {
        const enrollment = await enrollmentService.getEnrollmentByIdService(Number(req.params.id));
...
export const updateEnrollment = async (req: Request, res: Response) => {
    try {
        await enrollmentService.updateEnrollmentService(Number(req.params.id), req.body);
